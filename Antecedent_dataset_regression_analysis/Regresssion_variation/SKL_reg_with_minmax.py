...
def read_file(file_pass):
    ...
    with open('/Users/gqs/Downloads/Antecedent_dataset_regression_analysis/random_list.txt','a') as file:
...
def MLR(regression_lst):
    ...
    #cross validation
    cv_r2 = cross_val_score(ridge_model, independent_variables, dependent_values, cv=10, scoring='r2')
    cv_mrse = cross_val_score(ridge_model, independent_variables, dependent_values, cv=10, scoring = mrse_scorer)
