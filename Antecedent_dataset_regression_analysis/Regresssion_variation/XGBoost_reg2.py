...
def MLR(regression_lst):
    ...
    #cross validation
    cv_r2 = cross_val_score(xgb_model, independent_variables, dependent_values, cv=3, scoring='r2')
    cv_mrse = cross_val_score(xgb_model, independent_variables, dependent_values, cv=3, scoring = mrse_scorer)
